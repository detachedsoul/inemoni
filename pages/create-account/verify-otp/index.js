import VerifyOTP from "@components/create-account/VerifyOTP";
...
const VerifyOTPCode = () => {
	return (
		<>
            <Head>
                <title>Inemoni | Verify OTP</title>
                <meta
                    name="description"
                    content="Enter OTP to verify identity"
                />
            </Head>
