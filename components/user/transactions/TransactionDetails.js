...
const TransactionDetails = ({ transaction }) => {
    const showTransactionDetails = (transaction) => {
        const notNullValues = Object.entries(transaction.details).filter(([field, value]) => value !== null && value !== "null" && value !== "" && field !== 'text' && field !== 'provider' && field !== 'free_transfer' && field !== 'bank_code' && field !== 'remark' && field !== 'remarks');
