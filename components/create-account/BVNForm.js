	...
	return (
		...
		>
			<div className="space-y-6">
				...
				<div className={`fixed -top-6 bottom-0 left-0 z-[1024] h-full w-full bg-black/60 transition-transform ease-linear duration-500 ${isActive ? 'translate-y-0' : 'translate-y-[500%]'}`}>
