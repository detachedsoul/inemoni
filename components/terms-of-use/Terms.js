		...
		<div className="grid gap-8">
			<div>
                ...
                <div className="space-y-3">
                    <p>
                        These Terms and Conditions <span className="font-bold">(“Terms”)</span> govern the access and use of the IneMoni services provided by IneMoni Digital Concept LTD <span className="font-bold">(“IneMoni”, “we”, “us” or “our”)</span> to you <span className="font-bold">(“User”, “you” or “your”)</span>. It is important that you read and understand these Terms together with any other notice or policy that we may provide on specific occasions so that you are fully aware of your rights and obligations when accessing and using our services. These Terms supplement other notices and policies and are not intended to override them.
                    </p>
            ...
            <div>
				<h1 className="header text-3xl mb-2">
                ...
                <ul className="space-y-3">
                    <li>
                        <span className="font-bold">- “Account”</span> means the IneMoni account opened by you through our mobile app or web app.
                    </li>

                    <li>
                        <span className="font-bold">- “App”</span> means the IneMoni mobile app or web app that allows you to access and use our services.
                    </li>

                    <li>
                        <span className="font-bold">- “Banking Services”</span> means the banking services provided by IneMoni in partnership with licensed banks, such as deposit, withdrawal, transfer, balance inquiry, statement request, card management and other related services.
                    </li>

                    <li>
                        <span className="font-bold">- “BVN”</span> means Bank Verification Number, a unique identification number issued by the Nigeria Inter-Bank Settlement System (NIBSS) to individuals who have a bank account in Nigeria.
                    </li>

                    <li>
                        <span className="font-bold">- “KYC”</span> means Know Your Customer, the process of validating the identity of a User by verifying the personal details of the User and other information or details provided by the User to IneMoni.
                    </li>

                    <li>
                        <span className="font-bold">- “Services”</span> means the IneMoni services provided by us to you, which include Banking Services, Agency Banking, Cross-Border Payment, International Payment, Virtual Card, Savings, Loan and Bill Payments.
                    </li>

                    <li>
                        <span className="font-bold">- “Transaction”</span> means any transaction performed by you or on your behalf using our Services.
                    </li>
                </ul>
            ...
            <div className="space-y-8">
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <ul className="space-y-3 pl-2">
                                <li>
                                    - Download our App from the Google Play Store or Apple App Store or visit our website at <Link className="underline underline-offset-4" href="https://www.inemoni.org">www.inemoni.org.</Link>
                                </li>
                ...
                <div className="space-y-4">
                    <h2 className="pl-2 header secondary-header">
                        ...
                        IneMoni POS and Merchant Services
                    </h2>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <p>
                            7.1 We respect your privacy and security. We collect, use, store, disclose and protect your personal information in accordance with our Privacy Policy, which is available on our website at <Link className="underline underline-offset-4" href="https://www.inemoni.org/legal/privacy-policy" target="_blank" rel="noopener noreferrer">www.inemoni.org/legal/privacy-policy</Link>. You agree to our Privacy Policy when using our Services.
                        </p>
                ...
                <div className="space-y-4">
                    <h2 className="pl-2 header secondary-header">
                        ...
                        Inemoni Virtual Card
                    </h2>

                    <div className="space-y-3">
                        <p>
                            10.1 <span className="font-bold">Virtual Card Activation:</span> In order to activate the Virtual Card service, you must be a registered user with IneMoni and meet the eligibility criteria set forth by IneMoni. IneMoni reserves the right to refuse or revoke the activation of the Virtual Card service at its sole discretion.
                        </p>

                        <p>
                            10.2 <span className="font-bold">Virtual Card Usage:</span> The Virtual Card is intended for online purchases and transactions. You agree not to use the Virtual Card for any illegal or fraudulent activities. IneMoni reserves the right to monitor and investigate any suspicious or unauthorized use of the Virtual Card.
                        </p>

                        <p>
                            10.3 <span className="font-bold">Card Details:</span> The Virtual Card details, including the card number, expiration date, and CVV, will be provided to you upon activation. You are responsible for keeping the Virtual Card details confidential and ensuring its security. Any unauthorized use of the Virtual Card shall be your sole responsibility.
                        </p>

                        <p>
                            10.4 <span className="font-bold">Funding:</span> You can fund your Virtual Card by transferring funds from your IneMoni account or any other approved funding source specified by IneMoni. The available balance on your Virtual Card will be equal to the amount of funds transferred.
                        </p>

                        <p>
                            10.5  <span className="font-bold">Spending Limits:</span> IneMoni may impose spending limits on the Virtual Card, including but not limited to daily, weekly, or monthly limits. These limits will be communicated to you at the time of Virtual Card activation or through subsequent notifications.
                        </p>

                        <p>
                            10.6  <span className="font-bold">Expiry:</span> The Virtual Card will have an expiration date indicated on the card details. Once the Virtual Card expires, it will no longer be valid for use.
                        </p>

                        <p>
                            10.7 <span className="font-bold">Renewal:</span> IneMoni may offer the option to renew the Virtual Card, subject to eligibility criteria and applicable fees. The renewal process will be communicated to you in advance, and you will have the choice to renew or discontinue the Virtual Card service.
                        </p>

                        <p>
                            10.8 <span className="font-bold">Liability:</span> IneMoni shall not be liable for any losses, damages, or expenses arising from the use or misuse of the Virtual Card.
                        </p>

                        <p>
                            10.9 <span className="font-bold">Termination:</span> IneMoni may terminate your access to the Virtual Card service at any time without prior notice if you breach these Terms or the General Terms, or if IneMoni determines, in its sole discretion, that such termination is necessary or appropriate.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <p>
                            13.2 You may terminate your Account or access to our Services at any time by contacting us through our App or by email at <Link className="underline underline-offset-4" href="mailto:support@inemoni.com" target="_blank" rel="noopener noreferrrer">support@inemoni.com</Link>. You must pay any outstanding fees and charges and complete any pending Transactions before terminating your Account.
                        </p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <p>
                            15.1 Your use of the APP signifies your continuing consent to our privacy policy, which governs our collection and use of personal information that you supply to us. You can examine our privacy policy any time by <Link className="underline underline-offset-4" href="https://www.inemoni.org/legal/privacy-policy" target="_blank" rel="noopener noreferrer">clicking here</Link>
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    <h2 className="pl-2 header secondary-header">
                        ...
                        Using your wallet as a bypass account
                    </h2>
                    ...
                    <div className="space-y-3">
                        <div className="space-y-2">
                            ...
                            <ul className="space-y-3 pl-2 list-inside list-[lower-alpha]">
                                <li>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <p>
                            25.1 These terms and conditions are between you and us and
